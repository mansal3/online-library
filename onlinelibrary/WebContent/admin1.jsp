...
<table width="300" height="100" border="0" cellspacing="10" cellpadding="0" align="center"><%
	    ...
	    boolean status=verify.checkLogin(username,password);
		
		try {
		if(status==true){
			out.print("Welcome    " + username);
		    //out.print("<table>");
			out.print("<br><br><a href='newstaff.jsp'> Create new staff </a><br>");
			out.print("<br><a href='showstaff.jsp'> Show staff deatils </a><br>");
			out.print("<br><a href='bookdetails.jsp'> Show Book deatils </a><br>");
...
Connection con=DriverManager.getConnection(  "jdbc:mysql://localhost:3306/sonoo","root","root");  
	 ...
	 System.out.print("Please check your username and Password");
